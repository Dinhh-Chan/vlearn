...
import { ChevronRight, GraduationCap, BookOpen, Users, BarChart } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white dark:from-slate-950 dark:to-slate-900">
      ...
      <main className="container mx-auto px-4 py-12">
        <section className="flex flex-col md:flex-row gap-12 items-center mb-20">
          <div className="flex-1 space-y-6">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
              Học trực tuyến <span className="text-blue-600 dark:text-blue-400">hiệu quả</span> với nền tảng hiện đại
            </h1>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl">
              Tiếp cận các khóa học đa dạng, theo dõi tiến trình học tập và nhận chứng chỉ từ các giảng viên hàng đầu.
            </p>
          ...
          <div className="flex-1">
            <img src="/placeholder.svg?height=400&width=500" alt="Online Learning" className="rounded-lg shadow-xl" />
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>Tiếp cận kiến thức mọi lúc mọi nơi</CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2">
                  ...
                  <li className="flex items-center gap-2">
                    <ChevronRight className="h-4 w-4 text-blue-600 dark:text-blue-400" />
                    <span>Ghi chú và đánh dấu bài học</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <ChevronRight className="h-4 w-4 text-blue-600 dark:text-blue-400" />
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>Chia sẻ kiến thức và kiếm thu nhập</CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2">
                  <li className="flex items-center gap-2">
                  ...
                  <li className="flex items-center gap-2">
                    <ChevronRight className="h-4 w-4 text-blue-600 dark:text-blue-400" />
                    <span>Theo dõi thống kê và báo cáo</span>
                  </li>
                </ul>
              </CardContent>
              <CardFooter>
                <Link href="/instructor-demo">
                  <Button variant="outline" className="w-full">
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>Quản lý toàn diện hệ thống</CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2">
                  <li className="flex items-center gap-2">
                    <ChevronRight className="h-4 w-4 text-blue-600 dark:text-blue-400" />
                    <span>Quản lý khóa học và người dùng</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <ChevronRight className="h-4 w-4 text-blue-600 dark:text-blue-400" />
                  ...
                  <li className="flex items-center gap-2">
                    <ChevronRight className="h-4 w-4 text-blue-600 dark:text-blue-400" />
                    <span>Báo cáo và thống kê doanh thu</span>
                  </li>
                </ul>
              </CardContent>
              <CardFooter>
        ...
        <section className="text-center mb-20">
          <h2 className="text-3xl font-bold mb-6">Các tính năng nổi bật</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center mx-auto mb-4">
                <BookOpen className="h-6 w-6 text-blue-600 dark:text-blue-400" />
              </div>
              <h3 className="text-xl font-semibold mb-2">Đa dạng khóa học</h3>
              <p className="text-gray-600 dark:text-gray-300">Tiếp cận nhiều lĩnh vực kiến thức khác nhau</p>
            </div>
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center mx-auto mb-4">
                <Users className="h-6 w-6 text-blue-600 dark:text-blue-400" />
              ...
              <p className="text-gray-600 dark:text-gray-300">Trao đổi với giảng viên và học viên khác</p>
            </div>
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600 dark:text-gray-300">Nhận chứng nhận sau khi hoàn thành khóa học</p>
            </div>
            <div className="p-6 border rounded-lg hover:shadow-md transition-shadow">
              <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center mx-auto mb-4">
                <BarChart className="h-6 w-6 text-blue-600 dark:text-blue-400" />
              ...
              <p className="text-gray-600 dark:text-gray-300">Giám sát quá trình học tập của bạn</p>
            </div>
          </div>
        </section>
      </main>
